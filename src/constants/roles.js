...
export const MUALLIF_API_HOLAT = {
  ...
  TOLOVSIZ_QABUL_QILINGAN: "TOLOVSIZ_QABUL_QILINGAN",
...
export const MUALLIF_API_HOLAT_LABELS = {
  ...
  [MUALLIF_API_HOLAT.TOLOVSIZ_QABUL_QILINGAN]: "To'lovsiz qabul qilingan",
...
export const MUALLIF_API_HOLAT_COLORS = {
  ...
  [MUALLIF_API_HOLAT.TOLOVSIZ_QABUL_QILINGAN]: "bg-sky-100 text-sky-800 border-sky-200",
