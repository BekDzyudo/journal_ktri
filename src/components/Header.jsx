  ...
  return (
    ...
    >
      <div className="navbar gap-2 px-3.5 sm:px-5 mx-auto w-full xl:w-full 2xl:w-11/12 items-center">
        ...
        <div className="navbar-end 2xl:gap-4 xl:gap-2 gap-1.5">
          <Link to="/send-article" className="group relative cursor-pointer bg-white/95 hover:bg-white text-blue-700 hover:text-blue-800 font-bold py-2 sm:py-3 px-3 sm:px-4 xl:px-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 flex items-center gap-1.5 sm:gap-2 border-2 border-white/50 hover:border-white backdrop-blur-sm">
            <FaPaperPlane className="text-sm xl:text-base group-hover:rotate-12 transition-transform duration-300" />
            <span className="hidden sm:inline text-xs xl:text-sm whitespace-nowrap">Maqola berish</span>
